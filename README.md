...
- Angular 22 · strict TypeScript · RxJS
- Docker · GitHub Actions · Dependabot
- Azure Bicep infrastructure baseline

The project currently demonstrates domain modelling, layered application boundaries, EF Core persistence, API error handling, responsive Angular delivery, automated .NET tests and containerised local execution.

Azure production deployment, authentication, frontend automated tests and production observability remain explicit roadmap work.

## Featured engineering work

### [Helvetic Operations Platform](https://github.com/JinyanShao/helvetic-operations-platform)

A multi-site operations control tower built as one end-to-end enterprise application using C#, ASP.NET Core Minimal APIs, Entity Framework Core, SQL Server, Angular 22, strict TypeScript, Docker and Azure Bicep.

The current implementation includes guarded work-order lifecycle rules, an application-service and repository boundary, EF Core persistence, Problem Details, health checks, a responsive Angular dashboard, domain unit tests, multi-stage containers and GitHub Actions validation.

Authentication, database migrations, Angular component tests, end-to-end tests and production Azure networking are documented roadmap items rather than claimed features.
